...
export const case3Ch3: GameScenario = {
  ...
  "connectionRules": [
    ...
    {"id": "rule_C07", "cards": ["C01", "C04"], "result": "헤이스팅스 경의 통찰과 도르래 장치를 통해, 마리아 이바노바가 볼코프에게 수면제를 주었음을 확인합니다.", "unlock": "C07"},
    {"id": "rule_C08", "cards": ["C01", "C05"], "result": "헤이스팅스 경의 통찰과 슈미트 가족의 파산 경위를 통해, 대령 스미스의 아들이 볼코프가 연루된 식민지 학살에서 희생되었음을 확인합니다.", "unlock": "C08"},
