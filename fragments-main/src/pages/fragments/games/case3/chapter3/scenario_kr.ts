...
export const case3Ch3: GameScenario = {
  ...
  "suspects": [
    ...
    },
    {
      ...
      "name": "백작부인의 공범",
      "role": "용의자",
      "description": "엘레나 백작부인의 알리바이를 무너뜨린 이국적인 향수의 주인.",
      "alibi": "",
      "motive": ""
    }
  ],
  ...
  "locations": [],
  "connectionRules": [
    {"id": "rule_C04", "cards": ["C02", "C03"], "result": "금속 섬유 실과 밀실 트릭의 재구성을 통해, 사무엘 골드버그 침실에서 발견된 금속 조각이 도르래 장치임을 확인합니다.", "unlock": "C04"},
    {"id": "rule_C05", "cards": ["C01", "C02"], "result": "헤이스팅스 경의 통찰과 금속 섬유 실의 비밀을 통해, 닥터 슈미트 가족의 파산이 볼코프의 금융 스캔들과 관련 있음을 확인합니다.", "unlock": "C05"},
    {"id": "rule_C06", "cards": ["C01", "C03"], "result": "헤이스팅스 경의 통찰과 밀실 트릭의 재구성을 통해, 엘레나 백작부인의 알리바이를 무너뜨린 이국적인 향수의 주인을 파악합니다.", "unlock": "C06"},
    {"id": "rule_C07", "cards": ["C01", "C02"], "result": "헤이스팅스 경의 통찰과 금속 섬유 실의 비밀을 통해, 마리아 이바노바가 볼코프에게 수면제를 주었음을 확인합니다.", "unlock": "C07"},
    {"id": "rule_C08", "cards": ["C01", "C03"], "result": "헤이스팅스 경의 통찰과 밀실 트릭의 재구성을 통해, 대령 스미스의 아들이 볼코프가 연루된 식민지 학살에서 희생되었음을 확인합니다.", "unlock": "C08"},
    {"id": "rule_C09", "cards": ["C05", "C08"], "result": "슈미트 가족의 파산과 대령 스미스의 아들 희생을 연결하여, 용의자들 각자가 볼코프에게 강한 원한을 가지고 있음을 확인합니다.", "unlock": "C09"},
    {"id": "rule_C10", "cards": ["C04", "C09"], "result": "도르래 장치와 복수의 동기를 연결하여, 단검 손잡이의 톱니바퀴 문양이 '정의의 기계'를 상징함을 추론합니다.", "unlock": "C10"},
    {"id": "rule_C11", "cards": ["C06", "C07"], "result": "백작부인의 공범과 볼코프의 불면증 및 수면제를 연결하여, 각 용의자들이 살인에 기여한 방식과 역할이 드러납니다.", "unlock": "C11"},
    {"id": "rule_C12", "cards": ["C10", "C11"], "result": "톱니바퀴 문양의 의미와 공범들의 역할을 연결하여, 이 살인이 한 명의 범죄가 아닌, 여러 명의 공범에 의한 계획된 복수극임을 깨닫습니다.", "unlock": "C12"}
  ],
  "fragments": [],
  "winCondition": "C12",
