...
export const case3Ch4: GameScenario = {
  ...
  "connectionRules": [
    ...
    {"id": "rule_D05", "cards": ["D01", "D02"], "result": "헤이스팅스 경은 복수의 오케스트라를 통해 엘레나 백작부인이 볼코프에게 마지막 굴욕을 주고 싶었음을 밝혀냅니다.", "unlock": "D05"},
    {"id": "rule_D06", "cards": ["D01", "D02"], "result": "헤이스팅스 경은 복수의 오케스트라를 통해 마리아 이바노바가 볼코프에게 수면제를 주었음을 밝혀냅니다.", "unlock": "D06"},
    {"id": "rule_D07", "cards": ["D01", "D02"], "result": "헤이스팅스 경은 복수의 오케스트라를 통해 닥터 슈미트가 볼코프에게 복수심을 가지고 있었음을 밝혀냅니다.", "unlock": "D07"},
    {"id": "rule_D08", "cards": ["D01", "D02"], "result": "헤이스팅스 경은 복수의 오케스트라를 통해 대령 스미스가 볼코프를 찔렀음을 밝혀냅니다.", "unlock": "D08"},
