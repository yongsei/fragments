...
export const case3Ch2: GameScenario = {
  ...
  "connectionRules": [
    ...
    {"id": "rule_B05", "cards": ["B04", "B02"], "result": "엘레나의 이상한 향수 단서를 따라 복도를 더 조사하여, 닥터 슈미트의 침실에서 신문 스크랩을 발견합니다.", "unlock": "B05"},
    {"id": "rule_B06", "cards": ["B05", "B02"], "result": "슈미트의 신문 스크랩을 단서로 복도의 다른 침실들을 조사하여, 사무엘 골드버그의 침실에서 찢겨진 초상화를 발견합니다.", "unlock": "B06"},
    {"id": "rule_B07", "cards": ["B06", "B02"], "result": "골드버그의 찢어진 초상화를 단서로 복도를 계속 조사하여, 마리아 이바노바의 침실에서 약 냄새를 맡습니다.", "unlock": "B07"},
    {"id": "rule_B08", "cards": ["B07", "B02"], "result": "마리아의 약 냄새를 단서로 복도의 마지막 침실을 조사하여, 대령 존 스미스의 침실에서 오래된 지도를 발견합니다.", "unlock": "B08"},
    {"id": "rule_B09", "cards": ["B06", "B03"], "result": "골드버그의 찢겨진 초상화와 밀실의 역설을 연결하여, 작은 금속 조각이 밀실 트릭의 핵심 부품임을 추론합니다.", "unlock": "B09"},
    {"id": "rule_B10", "cards": ["B09", "B01"], "result": "금속 조각의 정체를 파악한 헤이스팅스 경이 볼코프의 시신을 재조사하여, 손에 쥐어진 얇은 실 조각을 발견합니다.", "unlock": "B10"},
    {"id": "rule_B11", "cards": ["B10", "B09"], "result": "얇은 실 조각과 금속 조각을 연결하여, 문 안쪽의 흠집이 실을 회수하는 과정에서 생긴 것임을 파악합니다.", "unlock": "B11"},
