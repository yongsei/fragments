...
export const case3Ch2: GameScenario = {
  ...
  "connectionRules": [
    {"id": "rule_B04", "cards": ["B01", "B03"], "result": "밀실 역설에 대한 헤이스팅스 경의 직감으로 엘레나 백작부인의 침실 문틈에서 이국적인 향수 냄새를 맡습니다.", "unlock": "B04"},
    {"id": "rule_B05", "cards": ["B01", "B04"], "result": "엘레나의 이상한 향수에 대한 직감으로 닥터 슈미트의 침실에서 신문 스크랩을 발견합니다.", "unlock": "B05"},
    {"id": "rule_B06", "cards": ["B01", "B05"], "result": "슈미트의 신문 스크랩 단서를 따라 사무엘 골드버그의 침실에서 찢겨진 초상화를 발견합니다.", "unlock": "B06"},
    {"id": "rule_B07", "cards": ["B01", "B06"], "result": "골드버그의 찢어진 초상화 단서를 따라 마리아 이바노바의 침실에서 약 냄새를 맡습니다.", "unlock": "B07"},
    {"id": "rule_B08", "cards": ["B01", "B07"], "result": "마리아의 약 냄새 단서를 따라 대령 존 스미스의 침실에서 오래된 지도를 발견합니다.", "unlock": "B08"},
