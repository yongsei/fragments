...
export const case5Ch2: GameScenario = {
  ...
  "connectionRules": [
    ...
    {"id": "rule_B12", "cards": ["B09", "B11"], "result": "작은 나무 상자와 환영 경험을 통해 '크로노스 프로토콜'을 파악합니다.", "unlock": "B12"},
    ...
    {"id": "rule_B15", "cards": ["B14", "B12"], "result": "'시간의 닻' 개념과 '크로노스 프로토콜'을 통해 미래에서 온 메시지를 재확인합니다.", "unlock": "B15"},
    {"id": "rule_B16", "cards": ["B13", "B11"], "result": "'믿음의 도약' 이론과 환영 경험을 통해 사라의 존재를 확인합니다.", "unlock": "B16"},
    {"id": "rule_B17", "cards": ["B10", "B16"], "result": "완벽하게 보존된 마른 장미와 사라의 존재를 통해 장미가 사라와 관련된 것임을 추론합니다.", "unlock": "B17"},
    {"id": "rule_B18", "cards": ["B17", "B15"], "result": "사라와 장미의 연결과 미래에서 온 메시지를 통해 2122년 뉴욕의 역사적 사건을 파악합니다.", "unlock": "B18"}
  ],
  "fragments": [],
  "winCondition": "B18",
