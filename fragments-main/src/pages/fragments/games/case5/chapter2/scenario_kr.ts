...
export const case5Ch2: GameScenario = {
  ...
  "locations": [],
  "connectionRules": [
    {"id": "rule_B04", "cards": ["B01", "B02"], "result": "앨리스터 핀치 교수와 김민준의 일지를 통해 '크로노스'가 단순한 살인자가 아닌, 시간을 조작하는 집단 의식 또는 조직임을 파악합니다.", "unlock": "B04"},
    {"id": "rule_B05", "cards": ["B01", "B03"], "result": "앨리스터 핀치 교수와 시간 이상 감지기를 통해 '시간 공명' 이론을 이해합니다.", "unlock": "B05"},
    {"id": "rule_B06", "cards": ["B05", "B02"], "result": "'시간 공명' 이론과 김민준의 일지를 통해 '시간의 메아리'의 개념을 파악합니다.", "unlock": "B06"},
    {"id": "rule_B07", "cards": ["B01", "B04"], "result": "앨리스터 핀치 교수와 '크로노스'의 정체를 통해 핀치가 1890년에 흔적도 없이 사라진 기록을 발견합니다.", "unlock": "B07"},
