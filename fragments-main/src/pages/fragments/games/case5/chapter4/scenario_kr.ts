...
export const case5Ch4: GameScenario = {
  ...
  "connectionRules": [
    ...
    {"id": "rule_D05", "cards": ["D04", "D01"], "result": "시간 터널 생성과 믿음의 도약 준비를 통해 시간 터널의 불안정성을 인지합니다.", "unlock": "D05"},
    {"id": "rule_D06", "cards": ["D05", "D01"], "result": "시간 터널의 불안정성과 믿음의 도약 준비를 통해 시간 역설의 위험을 인지합니다.", "unlock": "D06"},
    {"id": "rule_D07", "cards": ["D04", "D01"], "result": "시간 터널 생성과 믿음의 도약 준비를 통해 2122년 뉴욕에 도착합니다.", "unlock": "D07"},
