...
export const case5Ch5: GameScenario = {
  ...
  "connectionRules": [
    {"id": "rule_E04", "cards": ["E02", "E03"], "result": "노인의 증언과 시간의 수호자 개념을 통해 크로노스가 '대정화'를 시작했음을 파악합니다.", "unlock": "E04"},
    {"id": "rule_E05", "cards": ["E04", "E01"], "result": "'대정화'의 시작과 2122년 뉴욕의 현실을 통해 '잊혀진 영웅들의 기념비'를 발견합니다.", "unlock": "E05"},
    {"id": "rule_E06", "cards": ["E05", "E02"], "result": "'잊혀진 영웅들의 기념비'와 노인의 증언을 통해 기념비에 새겨진 김민준의 이름을 확인합니다.", "unlock": "E06"},
    {"id": "rule_E07", "cards": ["E05", "E06"], "result": "'잊혀진 영웅들의 기념비'와 김민준의 이름을 통해 기념비에 새겨진 앨리스터 핀치의 이름을 확인합니다.", "unlock": "E07"},
