...
export const case5ChEn5: GameScenario = {
  ...
  "connectionRules": [
    ...
    {"id": "rule_E07", "cards": ["E05", "E02"], "result": "Through the 'Monument to Forgotten Heroes' and the old man's testimony, you confirm Alistair Finch's name on the monument.", "unlock": "E07"},
