...
export const chapter1IntroData: ChapterIntroData = {
  ...
  keyCharacters: [
    ...
    {
      kr: '김민준 - 첫 번째 희생자',
      en: 'Kim Min-jun - First victim'
    },
    {
      kr: '크로노스 - 시간 여행자',
      en: 'Chronos - Time traveler'
    }
  ],
  keyEvidence: [
    {
      kr: '19세기 빅토리아 시대 회중시계',
      en: '19th-century Victorian pocket watch'
    },
    {
      kr: '과거 시대의 칼날 흔적',
  ...
  goal: {
    kr: '크로노스의 정체를 파악하고 시간 여행 살인의 첫 단서를 찾아보세요!',
    en: 'Identify Chronos and find the first clues of time travel murder!'
  },
  gameLink: '/fragments/case5/chapter1/game',
  theme: {
