...
export const case5Ch1: GameScenario = {
  ...
  "connectionRules": [
    {"id": "rule_A04", "cards": ["A01", "A02"], "result": "이진우 형사는 김민준의 시신을 통해 사건의 심각성을 인지하고 박준영 형사에게 수사를 지시합니다.", "unlock": "A04"},
    {"id": "rule_A05", "cards": ["A02", "A03"], "result": "김민준의 시신과 낡은 회중시계를 통해 20세기 초 칼날 흔적을 발견합니다.", "unlock": "A05"},
    {"id": "rule_A06", "cards": ["A03", "A05"], "result": "낡은 회중시계와 칼날 흔적을 통해 \"1888년 런던\" 각인을 확인합니다.", "unlock": "A06"},
    {"id": "rule_A07", "cards": ["A02", "A06"], "result": "김민준의 시신과 \"1888년 런던\" 각인을 통해 피해자의 손에 쥐여 있던 종이 조각을 발견합니다.", "unlock": "A07"},
    {"id": "rule_A08", "cards": ["A01", "A07"], "result": "이진우 형사는 김민준의 종이 조각을 통해 그의 연구실로 향합니다.", "unlock": "A08"},
    {"id": "rule_A09", "cards": ["A08", "A04"], "result": "김민준의 연구실에서 박준영 형사와 함께 미완성된 시간 이동 장치를 발견합니다.", "unlock": "A09"},
    {"id": "rule_A10", "cards": ["A09", "A05"], "result": "미완성된 시간 이동 장치와 칼날 흔적을 통해 장치 주변에서 시간 왜곡 에너지를 감지합니다.", "unlock": "A10"},
    {"id": "rule_A11", "cards": ["A08", "A04"], "result": "김민준의 연구실에서 박준영 형사와 함께 암호화된 태블릿을 발견합니다.", "unlock": "A11"},
