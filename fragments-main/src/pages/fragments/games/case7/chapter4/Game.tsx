...
import case7FeedbackData4 from './feedbackData_kr';
import case7FeedbackDataEn4 from './feedbackData_en';
...
const Chapter4Game: React.FC = () => {
  ...
  const feedbackData = language === 'en' ? case7FeedbackDataEn4 : case7FeedbackData4;
