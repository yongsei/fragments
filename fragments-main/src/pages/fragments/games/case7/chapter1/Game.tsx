...
import { feedbackCase7Ch1 } from './feedbackData_kr';
import { feedbackCase7Ch1En } from './feedbackData_en';
...
const Chapter1Game: React.FC = () => {
  ...
  const feedbackData = language === 'en' ? feedbackCase7Ch1En : feedbackCase7Ch1;
