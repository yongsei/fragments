...
import { feedbackCase7Ch2 } from './feedbackData_kr';
import { feedbackCase7Ch2En } from './feedbackData_en';
...
const Chapter2Game: React.FC = () => {
  ...
  const feedbackData = language === 'en' ? feedbackCase7Ch2En : feedbackCase7Ch2;
