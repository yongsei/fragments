export const case8_chapter1_kr = {
  id: 'case8_chapter1',
  title: '챕터 1: 반복되는 그림자',
  story: '마을에 갇힌 여행자가 기이한 반복 현상들을 목격하며 저주의 존재를 어렴풋이 인지하고, 엘라라 할머니와의 첫 만남을 통해 알 수 없는 경고를 듣는 과정.',
  victim: '',
  suspects: [
    {
      id: 'B01',
  ...
  evidence: [
    ...
    },
    {
      id: 'B19',
      name: '숨겨진 진실',
      description: '마을 주민들과 추가 인물들의 행동에서 드러나는 새로운 사실.',
      details: '반복되는 일상 속에서 발견되는 저주의 실체가 더욱 명확해진다.',
      location: 'B04'
    },
    {
      id: 'B20',
      ...
      details: '시간의 흐름이 멈춘 장소들이 어떻게 연결되어 있는지를 보여준다.',
      location: 'B11'
    },
    {
      id: 'B21',
      name: '어둠의 신호',
      description: '반복되는 현상과 추가 증거 사이에서 발견되는 초자연적 연관성.',
      details: '저주가 어떻게 마을 전체를 지배하고 있는지를 드러낸다.',
      location: 'B05'
    },
    {
      id: 'B22',
      name: '깊은 의미',
      description: '엘라라의 경고와 숨겨진 진실이 결합되어 드러나는 저주의 진정한 의미.',
      details: '시간의 반복이 단순한 현상이 아니라 의도된 저주임을 밝혀낸다.',
      location: 'B19'
    },
    {
      id: 'B23',
      ...
      details: '반복되는 그림자의 정체와 이를 해결할 실마리를 제공한다.',
      location: 'B20'
    }
  ],
  locations: [
  ...
  connectionRules: [
    ...
    // 추가 연결 규칙들 - 모든 카드가 승리에 필요하도록
    {
      id: 'rule_B04_B06_B19',
      cards: ['B04', 'B06'],
      result: '마을 주민들과 마지막 인물의 증언이 결합되어 새로운 진실이 드러납니다.',
      unlock: 'B19'
    },
    {
      id: 'rule_B10_B12_B20',
      cards: ['B10', 'B12'],
      result: '낡은 숙소와 마지막 장소의 연결고리가 발견되었습니다.',
      unlock: 'B20'
    },
    {
      id: 'rule_B05_B11_B21',
      cards: ['B05', 'B11'],
      result: '반복적 인물과 추가 장소 사이의 숨겨진 연관성이 밝혀졌습니다.',
      unlock: 'B21'
    },
    {
      id: 'rule_B16_B19_B22',
      cards: ['B16', 'B19'],
      result: '아이들의 노래와 숨겨진 진실이 결합되어 더 깊은 의미를 찾았습니다.',
      unlock: 'B22'
    },
    {
      id: 'rule_B20_B21_B23',
    ...
    // 최종 승리 조합
    {
      id: 'rule_B22_B23_B18',
      cards: ['B22', 'B23'],
      result: '챕터 1의 모든 진실이 하나로 연결되며, 마을의 반복되는 그림자와 저주의 존재가 명확히 드러납니다.',
      unlock: 'B18'
    }
  ],
  fragments: [],
