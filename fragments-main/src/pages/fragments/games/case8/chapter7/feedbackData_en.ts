  ...
  combinationFeedback: [
    ...
    },
    {
      ...
      messages: [
        ...
        "💡 Confirm the impact the curse has had on your body through the player and the vibration of the Fragment of the Loop."
      ]
    },
    {
      cards: ['G03', 'G15'],
    ...
    },
    {
      ...
      messages: [
        ...
        "A deeper mental scar, more profound than physical fatigue, weighs him down.",
        "📖 Confirm the impact the curse has had on your life through the player and the road leaving the village."
      ]
    },
    {
      cards: ['G05', 'G17'],
    ...
    },
    {
      ...
      messages: [
        ...
        "🔍 Confirm the lasting impact the curse has had on your life through the Echowood shadow in daily life and the new fog space."
      ]
    },  
    {
      cards: ['G07', 'G08'],
    ...
    },
    {
      ...
      messages: [
        ...
        "💭 This combination describes the current situation, but is not a core clue."
      ]
    }
  ],
  urgentHints: [
    '🚨 Urgent Report: Alex\'s notebook is no longer being written in, showing the collapse of his logical worldview.',
    '🚨 On-site Evidence: The vibration of the \'Fragment of the Loop\' still remains at the player\'s fingertips.',
    '🚨 Forensic Report: The memory of Echowood Village suddenly comes to mind even in ordinary daily life.',
    '🚨 Financial/Communication Investigation: Lily\'s drawings repeating in dreams show that the village\'s nightmare is deeply embedded in the subconscious.'
  ],
  contextualHints: [
    '💡 Deduction Tip: Even though the curse is lifted, not everything is over. It\'s important to accept the remaining scars and changes.',
    '💡 Investigation Perspective: Reflect on how the Echowood Village experience has affected your life.',
    '💡 Criminal Psychology: Nightmares and illusions show that past trauma continues to affect the present.',
    '💡 Physical Evidence Analysis: Physical evidence has disappeared, but mental remnants still remain.',
    '💡 Timeline: Organize how the Echowood Village experience has changed your life in chronological order.'
  ]
};