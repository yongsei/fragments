...
export const caseCh1: GameScenario = {
  ...
  "connectionRules": [
    ...
    {"id": "rule_A08", "cards": ["A04", "A01"], "result": "시신의 상태를 보아, 단서는 현장보다 피해자의 주변에 있을 것이라 판단하고 개인실로 향합니다.", "unlock": "A08"},
    ...
    {"id": "rule_A11", "cards": ["A10", "A01"], "result": "사라진 성배의 능력을 깨닫고, 범인의 다음 목적을 추론해냅니다.", "unlock": "A11"},
    {"id": "rule_A12", "cards": ["A08", "A10"], "result": "개인실과 사라진 성배의 연관성을 찾던 중, 대주교가 무언가를 비밀리에 연구했음을 알게 됩니다.", "unlock": "A12"}
  ],
  "fragments": [],
  "winCondition": "A12",
