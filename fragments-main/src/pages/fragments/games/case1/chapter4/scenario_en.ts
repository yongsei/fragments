...
export const caseChEn4: GameScenario = {
  ...
  "connectionRules": [
    ...
    {"id": "rule_D08", "cards": ["D07", "D05"], "result": "Under continued interrogation, he also reveals that he murdered the Archbishop who had noticed his experiments.", "unlock": "D08"},
    {"id": "rule_D09", "cards": ["D08", "D02"], "result": "You uncover the identity of the \"shadow that chirps like a bird\"—a creature born from Valerius's twisted soul and the children's sacrifice.", "unlock": "D09"},
    {"id": "rule_D10", "cards": ["D09", "D04"], "result": "In the secret laboratory, you discover the irrefutable evidence of his crimes: the 'shattered souls'.", "unlock": "D10"},
    {"id": "rule_D11", "cards": ["D10", "D06"], "result": "With everything revealed, Valerius, in a final act of desperation, causes his shadow to go berserk and attack you.", "unlock": "D11"},
