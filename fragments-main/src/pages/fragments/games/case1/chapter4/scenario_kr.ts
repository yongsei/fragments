...
export const caseCh4: GameScenario = {
  ...
  "connectionRules": [
    ...
    {"id": "rule_D08", "cards": ["D07", "D06"], "result": "계속된 추궁 끝에, 자신의 실험을 눈치챈 대주교를 살해했다는 사실까지 밝혀집니다.", "unlock": "D08"},
    {"id": "rule_D09", "cards": ["D05", "D02"], "result": "발레리우스의 뒤틀린 영혼과 아이들의 희생으로 만들어진 '새 지저귀는 그림자'의 정체를 파악합니다.", "unlock": "D09"},
    {"id": "rule_D10", "cards": ["D09", "D07"], "result": "비밀 실험실에서, 그의 범행에 대한 반박 불가한 증거인 '조각난 영혼'들을 발견합니다.", "unlock": "D10"},
    {"id": "rule_D11", "cards": ["D06", "D09"], "result": "모든 것이 드러나자, 발레리우스가 최후의 발악으로 그림자를 폭주시켜 당신을 공격합니다.", "unlock": "D11"},
