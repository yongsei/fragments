...
export const caseCh2: GameScenario = {
  ...
  "connectionRules": [
    {"id": "rule_B04", "cards": ["B01", "B02"], "result": "대주교의 비밀 연구와 사라진 성배를 연결하여, 범인이 찾던 것이 '빈민가의 기적'과 관련있다고 추론합니다.", "unlock": "B04"},
    {"id": "rule_B05", "cards": ["B04", "B03"], "result": "빈민가에서 대주교의 흔적을 찾던 중, 그가 자주 들렀다는 구호소를 발견합니다.", "unlock": "B05"},
    ...
    {"id": "rule_B09", "cards": ["B08", "B02"], "result": "실체적인 공포와 사라진 성배를 연결하여, 뒷골목 정보상의 도움이 필요하다고 판단합니다.", "unlock": "B09"},
