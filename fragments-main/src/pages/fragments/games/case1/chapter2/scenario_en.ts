...
export const caseChEn2: GameScenario = {
  ...
  "connectionRules": [
    {"id": "rule_B04", "cards": ["B01", "B02"], "result": "Connecting the Archbishop's secret research with the missing chalice, you deduce that what the culprit sought is related to the 'Miracle of the Slums'.", "unlock": "B04"},
    {"id": "rule_B05", "cards": ["B04", "B03"], "result": "While searching for traces of the Archbishop in the slums, you discover a shelter he often visited.", "unlock": "B05"},
    ...
    {"id": "rule_B09", "cards": ["B08", "B02"], "result": "Connecting the tangible terror with the missing chalice, you decide you need the help of a back-alley informant.", "unlock": "B09"},
