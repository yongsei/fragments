...
export const caseCh3: GameScenario = {
  ...
  "connectionRules": [
    ...
    {"id": "rule_C06", "cards": ["C03", "C04"], "result": "거래 대신, 당신만이 아는 교단의 약점을 이용해 정보상을 압박하는 데 성공합니다.", "unlock": "C06"},
    {"id": "rule_C07", "cards": ["C05", "C06"], "result": "거래와 협박 끝에, 마침내 정보상이 소문의 본질에 대한 충격적인 증언을 털어놓습니다.", "unlock": "C07"},
    {"id": "rule_C08", "cards": ["C07", "C01"], "result": "정보상의 증언을 바탕으로, 소문의 근원지가 '잿빛 고아원'임을 특정하고 즉시 그곳으로 향합니다.", "unlock": "C08"},
    {"id": "rule_C09", "cards": ["C08", "C02"], "result": "고아원 주변을 탐문하며, 아이들이 자주 바뀐다는 좋지 않은 평판을 듣게 됩니다.", "unlock": "C09"},
    {"id": "rule_C10", "cards": ["C08", "C03"], "result": "정면 돌파는 위험하다고 판단, 당신은 심문관의 기술을 이용해 고아원에 잠입할 계획을 세웁니다.", "unlock": "C10"},
    {"id": "rule_C11", "cards": ["C10", "C09"], "result": "고아원에 잠입하여 마주한 아이들의 모습은, 끔찍한 소문이 사실임을 증명하고 있습니다.", "unlock": "C11"},
    {"id": "rule_C12", "cards": ["C11", "C10"], "result": "이 모든 일의 원흉이 있을 곳, 원장실로 향합니다. 문틈으로 불길한 기운이 새어 나옵니다.", "unlock": "C12"}
  ],
  "fragments": [],
  "winCondition": "C12",
