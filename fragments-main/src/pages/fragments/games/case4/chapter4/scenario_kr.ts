...
export const case4Ch4: GameScenario = 
{
  ...
  "connectionRules": [
    ...
    {"id": "rule_D05", "cards": ["D01", "D02"], "result": "빅터 크로우는 공범들의 연극을 통해 아엘렌 실버우드가 마법 증폭 장치를 제공했음을 밝혀냅니다.", "unlock": "D05"},
    {"id": "rule_D06", "cards": ["D01", "D02"], "result": "빅터 크로우는 공범들의 연극을 통해 릴리아나 베인이 스톤위크의 연구 방식에 대한 윤리적 문제 제기에도 불구하고 침묵했음을 밝혀냅니다.", "unlock": "D06"},
    {"id": "rule_D07", "cards": ["D01", "D02"], "result": "빅터 크로우는 공범들의 연극을 통해 그록 블러드액스가 스톤위크에게 가족을 잃었지만, 그를 지키지 못했음을 자책하는 모순된 진술을 했음을 밝혀냅니다.", "unlock": "D07"},
    {"id": "rule_D08", "cards": ["D01", "D02"], "result": "빅터 크로우는 공범들의 연극을 통해 카이렌 나이트쉐이드가 스톤위크의 심장을 자신의 몸에 이식하여 불멸을 얻으려 했음을 고백하게 합니다.", "unlock": "D08"},
