...
export const case4ChEn4: GameScenario = 
{
  ...
  "connectionRules": [
    ...
    {"id": "rule_D05", "cards": ["D01", "D02"], "result": "Victor Crow, through the accomplices' play, reveals that Aelen Silverwood provided the magic amplification device.", "unlock": "D05"},
    {"id": "rule_D06", "cards": ["D01", "D02"], "result": "Victor Crow, through the accomplices' play, reveals that Liliana Bane remained silent despite having raised ethical concerns about Stonewick's research methods.", "unlock": "D06"},
    {"id": "rule_D07", "cards": ["D01", "D02"], "result": "Victor Crow, through the accomplices' play, reveals that Grok Bloodaxe made a contradictory statement about losing family to Stonewick but blaming himself for not protecting him.", "unlock": "D07"},
    {"id": "rule_D08", "cards": ["D01", "D02"], "result": "Victor Crow, through the accomplices' play, makes Kairen Nightshade confess to having implanted Stonewick's heart into his own body to gain immortality.", "unlock": "D08"},
