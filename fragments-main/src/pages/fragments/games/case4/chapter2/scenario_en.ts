...
export const case4ChEn2: GameScenario = 
{
  ...
  "locations": [],
  "connectionRules": [
    {"id": "rule_B04", "cards": ["B02", "B03"], "result": "Victor Crow analyzes the clues in the worn leather pouch and uncovers the identity of the Blood Rose.", "unlock": "B04"},
    {"id": "rule_B05", "cards": ["B04", "B03"], "result": "Victor Crow understands the meaning of the Heartbreaker Silver Coin through his Blood Rose research.", "unlock": "B05"},
    {"id": "rule_B06", "cards": ["B02", "B01"], "result": "Victor Crow analyzes the faintly glowing crystal shard and realizes the magic staff's crack was caused by an extremely powerful magical energy.", "unlock": "B06"},
    {"id": "rule_B07", "cards": ["B05", "B06"], "result": "Victor Crow discovers a small, agile footprint on the lab floor through his Heartbreaker Silver Coin analysis.", "unlock": "B07"},
