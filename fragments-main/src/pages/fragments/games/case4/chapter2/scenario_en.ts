...
export const case4ChEn2: GameScenario = 
{
  ...
  "connectionRules": [
    ...
    {"id": "rule_B05", "cards": ["B01", "B03"], "result": "Victor Crow analyzes the clues in the worn leather pouch and understands the meaning of the Heartbreaker Silver Coin.", "unlock": "B05"},
    ...
    {"id": "rule_B07", "cards": ["B01", "B02"], "result": "Victor Crow analyzes the faintly glowing crystal shard and discovers a small, agile footprint on the lab floor.", "unlock": "B07"},
    {"id": "rule_B08", "cards": ["B01", "B04"], "result": "Victor Crow obtains information about the Heartstone of Life through the Blood Rose and his analysis.", "unlock": "B08"},
    {"id": "rule_B09", "cards": ["B01", "B04"], "result": "Victor Crow secures a statement implying Stonewick tried to gain immortality using his own heart, through the Blood Rose and his analysis.", "unlock": "B09"},
    {"id": "rule_B10", "cards": ["B01", "B04"], "result": "Victor Crow discovers an ancient Elf magic circle under the lab desk through the Blood Rose and his analysis.", "unlock": "B10"},
    ...
    {"id": "rule_B14", "cards": ["B07", "B09"], "result": "Through the small, agile footprint and Stonewick's heart research, Grok Bloodaxe makes a contradictory statement: he lost family to Stonewick but blames himself for not protecting him.", "unlock": "B14"},
    {"id": "rule_B15", "cards": ["B07", "B09"], "result": "Through the small, agile footprint and Stonewick's heart research, Kairen Nightshade's footprint is confirmed to match the one on the lab floor.", "unlock": "B15"},
    ...
    {"id": "rule_B18", "cards": ["B08", "B09"], "result": "Through the Heartstone of Life information and Stonewick's heart research, you hypothesize that Stonewick tried to recreate the 'Heartstone of Life' using his own heart.", "unlock": "B18"}
  ],
  "fragments": [],
  "winCondition": "B18",
