...
export const case4Ch2: GameScenario = {
  ...
  "connectionRules": [
    ...
    {"id": "rule_B05", "cards": ["B01", "B04"], "result": "빅터 크로우는 피의 장미 연구를 통해 심장 파괴자 은화의 의미를 파악합니다.", "unlock": "B05"},
    {"id": "rule_B06", "cards": ["B01", "B02"], "result": "빅터 크로우는 희미하게 빛나는 수정 조각을 분석하여 마법 지팡이의 균열이 극도로 강력한 마법 에너지에 의해 발생했음을 파악합니다.", "unlock": "B06"},
    {"id": "rule_B07", "cards": ["B01", "B05"], "result": "빅터 크로우는 심장 파괴자 은화 분석을 통해 연구실 바닥에서 작고 날렵한 발자국을 발견합니다.", "unlock": "B07"},
