...
export const case4Ch2: GameScenario = {
  ...
  "locations": [],
  "connectionRules": [
    {"id": "rule_B04", "cards": ["B01", "B03"], "result": "빅터 크로우는 낡은 가죽 주머니 속 단서들을 분석하여 피의 장미의 정체를 밝혀냅니다.", "unlock": "B04"},
    {"id": "rule_B05", "cards": ["B01", "B03"], "result": "빅터 크로우는 낡은 가죽 주머니 속 단서들을 분석하여 심장 파괴자 은화의 의미를 파악합니다.", "unlock": "B05"},
    {"id": "rule_B06", "cards": ["B01", "B02"], "result": "빅터 크로우는 희미하게 빛나는 수정 조각을 분석하여 마법 지팡이의 균열이 극도로 강력한 마법 에너지에 의해 발생했음을 파악합니다.", "unlock": "B06"},
    {"id": "rule_B07", "cards": ["B01", "B02"], "result": "빅터 크로우는 희미하게 빛나는 수정 조각을 분석하여 연구실 바닥에서 작고 날렵한 발자국을 발견합니다.", "unlock": "B07"},
    {"id": "rule_B08", "cards": ["B01", "B04"], "result": "빅터 크로우는 피의 장미와 자신의 분석을 통해 생명의 심장석에 대한 정보를 얻습니다.", "unlock": "B08"},
    {"id": "rule_B09", "cards": ["B01", "B04"], "result": "빅터 크로우는 피의 장미와 자신의 분석을 통해 스톤위크가 자신의 심장을 이용해 불멸을 얻으려 했음을 암시하는 진술을 확보합니다.", "unlock": "B09"},
    {"id": "rule_B10", "cards": ["B01", "B04"], "result": "빅터 크로우는 피의 장미와 자신의 분석을 통해 연구실 책상 아래에서 고대 엘프 마법진을 발견합니다.", "unlock": "B10"},
    ...
    {"id": "rule_B14", "cards": ["B07", "B09"], "result": "작고 날렵한 발자국과 스톤위크의 심장 연구를 통해 그록 블러드액스가 스톤위크에게 가족을 잃었지만, 그를 지키지 못했음을 자책하는 모순된 진술을 합니다.", "unlock": "B14"},
    {"id": "rule_B15", "cards": ["B07", "B09"], "result": "작고 날렵한 발자국과 스톤위크의 심장 연구를 통해 카이렌 나이트쉐이드의 발자국이 연구실 바닥의 발자국과 일치함을 확인합니다.", "unlock": "B15"},
    ...
    {"id": "rule_B18", "cards": ["B08", "B09"], "result": "생명의 심장석 정보와 스톤위크의 심장 연구를 통해 스톤위크가 자신의 심장을 이용해 '생명의 심장석'을 재현하려 했다는 가설을 세웁니다.", "unlock": "B18"}
  ],
  "fragments": [],
  "winCondition": "B18",
