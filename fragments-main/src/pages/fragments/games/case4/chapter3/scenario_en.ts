...
export const case4ChEn3: GameScenario = 
{
  ...
  "connectionRules": [
    ...
    {"id": "rule_C06", "cards": ["C01", "C02"], "result": "Victor Crow, through the secret of the Blood Rose, realizes Liliana Bane remained silent despite having raised ethical concerns about Stonewick's research methods.", "unlock": "C06"},
    ...
    {"id": "rule_C08", "cards": ["C01", "C02"], "result": "Victor Crow, through the secret of the Blood Rose, confirms that Kairen Nightshade's footprint matches the one on the lab floor.", "unlock": "C08"},
