...
export const case4Ch3: GameScenario = 
{
  ...
  "locations": [],
  "connectionRules": [
    {"id": "rule_C04", "cards": ["C01", "C02"], "result": "빅터 크로우는 피의 장미의 비밀을 통해 아엘렌 실버우드가 피의 장미가 살아있는 심장을 필요로 하는 의식에 사용됨을 인정하게 합니다.", "unlock": "C04"},
    {"id": "rule_C05", "cards": ["C01", "C03"], "result": "빅터 크로우는 심장 파괴자 은화의 의미를 통해 그림록 스틸해머가 스톤위크에게 특정 부품을 의뢰했으나 용도를 알려주지 않았음을 털어놓게 합니다.", "unlock": "C05"},
    {"id": "rule_C06", "cards": ["C01", "C02"], "result": "빅터 크로우는 피의 장미의 비밀을 통해 릴리아나 베인이 스톤위크의 연구 방식에 대한 윤리적 문제 제기에도 불구하고 침묵했음을 파악합니다.", "unlock": "C06"},
    ...
    {"id": "rule_C08", "cards": ["C01", "C02"], "result": "빅터 크로우는 피의 장미의 비밀을 통해 카이렌 나이트쉐이드의 발자국이 연구실 바닥의 발자국과 일치함을 확인합니다.", "unlock": "C08"},
