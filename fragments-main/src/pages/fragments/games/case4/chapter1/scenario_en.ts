...
export const case4ChEn1: GameScenario = {
  ...
  "connectionRules": [
    ...
    {"id": "rule_A05", "cards": ["A04", "A03"], "result": "Through Stonewick's body and the missing heart, you find a subtle crack at the tip of his magic staff.", "unlock": "A05"},
    ...
    {"id": "rule_A07", "cards": ["A03", "A04"], "result": "Through Stonewick's body and the missing heart, you find a worn leather pouch tightly clutched in his hand.", "unlock": "A07"},
    ...
    {"id": "rule_A09", "cards": ["A07", "A08"], "result": "Through the worn leather pouch and the crystal shard, you discover a silver coin with an unknown emblem inside the pouch.", "unlock": "A09"},
