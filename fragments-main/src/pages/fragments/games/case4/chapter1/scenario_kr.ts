...
export const case4Ch1: GameScenario = {
  ...
  "connectionRules": [
    {"id": "rule_A04", "cards": ["A02", "A03"], "result": "스톤위크의 시신을 아르카눔 타워 연구실에서 면밀히 조사한 결과, 그의 가슴에서 심장이 완전히 사라졌음을 발견합니다.", "unlock": "A04"},
    {"id": "rule_A05", "cards": ["A04", "A03"], "result": "사라진 심장의 미스터리를 연구실에서 더 조사하여, 스톤위크의 마법 지팡이 끝에 난 미세한 균열을 발견합니다.", "unlock": "A05"},
    {"id": "rule_A06", "cards": ["A02", "A05"], "result": "스톤위크의 시신과 마법 지팡이의 균열을 통해, 시신 옆에서 희미하게 빛나는 수정 조각을 발견합니다.", "unlock": "A06"},
    {"id": "rule_A07", "cards": ["A03", "A04"], "result": "연구실과 사라진 심장을 통해, 스톤위크의 손에 꽉 쥐여 있던 낡은 가죽 주머니를 발견합니다.", "unlock": "A07"},
    {"id": "rule_A08", "cards": ["A07", "A06"], "result": "낡은 가죽 주머니와 수정 조각을 통해, 주머니 안에서 말라붙은 붉은 꽃잎을 발견합니다.", "unlock": "A08"},
    {"id": "rule_A09", "cards": ["A07", "A08"], "result": "낡은 가죽 주머니와 말라붙은 붉은 꽃잎을 통해, 주머니 안에서 알 수 없는 문양의 은화를 발견합니다.", "unlock": "A09"},
